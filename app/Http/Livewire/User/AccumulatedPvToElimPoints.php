...
class AccumulatedPvToElimPoints extends Component
{
    ...
    public function updatedAmount()
    {
        ...
        $this->balance_after_conversion = auth()->user()->earned_pv - $this->amount;
    }
    ...
    public function apply()
    {
        ...
        if($this->balance_after_conversion < 0){
            return redirect()->route('user.pvexchangeaccumulationelimpoint')->with('toast_error', 'Insufficient Funds');
        }
        ...
        return $application? 
        redirect()
        ->route('user.pvexchangeaccumulationelimpoint')
    ...
    {
        return view('livewire.user.accumulated-pv-to-elim-points');
    }
}
