     ...
     <div class="col-md-10 col-12   h-20">
         <div class="box-bor-detail mb-20">
             ...
             <div class="form-group row mt-4">
                 ...
                 <input type="number" min="1" max="{{ auth()->user()->elim_points }}" wire:model="exchange_quantity" class="form-control pro-pv-input col-xl-7 col-lg-9 col-md-9 col-sm-11 col-11 ml-2 mb-1" placeholder="">
                 <button class="btn-max " wire:click="getMaxElimPoint">MAX</button>
             ...
             <div class="form-group row mr-sp">
                 ...
                 <input type="number" disabled wire:model.defer="exchange_fee" class="form-control pro-pv-inputs col-xl-7 col-lg-9 col-md-9 col-sm-11 col-11 ml-2 mr-md-4 mr-1" placeholder="">
             ...
             <div class="form-group row mr-sp">
                 ...
                 <input type="number" disabled value="{{ $conversion_quantity }}" wire:model.defer="conversion_quantity" class="form-control pro-pv-inputs col-xl-7 col-lg-9 col-md-9 col-sm-11 col-11 ml-2 mr-md-4 mr-2 " placeholder="">
             ...
             <div class="form-group row mr-sp">
                 ...
                 <input type="number" disabled wire:model="balance_after_exchange" class="form-control pro-pv-inputs col-xl-7 col-lg-9 col-md-9 col-sm-11 col-11 ml-2 mr-md-4 mr-1" placeholder="">
