      ...
      <div class="row justify-content-center">
          <div class="col-lg-8 col-md-9 col-sm-10 col-12">
              <div class="form-group row mt-3">
                  ...
                  <input wire:model="conversion_quantity" type="number" class="form-control pro-pv-input col-xl-7 col-lg-9 col-md-9 col-9 ml-2" placeholder="">
              ...
              <div class="row mb-4">
                  ...
                  <div class="col-xl-7 col-lg-10 col-md-12 col-sm-10 col-12 px-0">
                      <ul class="rs-details">
                          <li><button class="btn-rp-detail" wire:click="$set('conversion_quantity', '500000')">500,000</button></li>
                          <li><button class="btn-rp-detail" wire:click="$set('conversion_quantity', '1000000')">1 million</button></li>
                          <li><button class="btn-rp-detail" wire:click="$set('conversion_quantity', '2000000')">2 million</button></li>
                          <li> <button class="btn-rp-detail" wire:click="$set('conversion_quantity', '10000000')">10 million</button></li>
                      </ul>
                  </div>
              </div>
              <div class="form-group row mr-sp">
                  ...
                  <input wire:model.defer="conversion_fee" type="number" class="form-control pro-pv-inputs col-xl-7 col-lg-9 col-md-9 col-9 ml-2" placeholder="">
              ...
              <div class="form-group row mt-3">
                  ...
                  <input wire:model.defer="quantity_after_conversion" type="number" class="form-control pro-pv-inputs col-xl-7 col-lg-9 col-md-9 col-9 ml-2" placeholder="">
              ...
              <div class="form-group row mt-3">
                  ...
                  <input wire:model.defer="balance_after_conversion" type="number" class="form-control pro-pv-inputs col-xl-7 col-lg-9 col-md-9 col-9 ml-2" placeholder="">
                  <div class="elim-point-text">PV</div>
              </div>
