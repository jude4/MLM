    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12 table-start">
                ...
                <table class="table-bordered table-hover dt-responsive border-bottom-0 border-remove" id="pvconversionapplicationdetaillistdata">
...
<script>
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.status == 200) {
                    $("#pv-conversion-approval-modal").modal('hide');
    ...
    function cancelrequest() {
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.status == 200) {
                    $("#pv-conversion-cancel-modal").modal('hide');
                    $("#pvconversionapplicationdetaillist").html(response.msg);
                    cancelmodalclose();
                } else {
                    toastr.error(response.msg);
    ...
    function searchhistory() {
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.status == 200) {
                    $('#pvconversionapplicationdetaillistdata').dataTable().fnDestroy();
                    $("#pvconversionapplicationdetaillist").html(response.msg);
                    $('#pvconversionapplicationdetaillistdata').dataTable();
                }
            }
        });
    }
