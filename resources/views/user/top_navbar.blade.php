                                ...
                                <div class="row justify-content-center">
                                    <div class="col-11 p-2">
                                        <div class="sml-scree-box">
                                            <div class="text-center sp-smd-text">gyewang01</div>
                                            <div class="text-center sp-smd-texts">Gyewang 01</div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="rig-menu-dis  d-md-inline-block d-none">
                                    <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                                                <img class="dropbtn" src="{{asset('image/users-drp01.png')}}" width="40px">
                                                 <div class="d-inline-block us-name-text ml-2">Gyewang 01</div>
                                            </a>
                                            <div class="dropdown-menu">
